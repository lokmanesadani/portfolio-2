...
const Introduction = () => {
  return (
    <div className="max-w-6xl w-full  pb-10 flex flex-col">
      <div
        className="flex flex-1 flex-col-reverse md:flex-row max-md:flex-1 
      "
      >
        <div className="w-full flex-1 flex flex-col text-white justify-center">
        ...
        <div className="flex relative flex-1 items-center  justify-center flex-col">
          <Spline
            className="absolute top-1/2 -translate-x-1/2 -translate-y-1/2 left-1/2 scale-[0.7] sm:scale-75 md:scale-100 lg:scale-[1.1]"
